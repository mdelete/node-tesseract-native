...
node-tesseract-native.o: node-tesseract-native.cc
	g++ -Wall -fPIC -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -I/usr/local/include -I/usr/local/include/node -c node-tesseract-native.cc -o node-tesseract-native.o
